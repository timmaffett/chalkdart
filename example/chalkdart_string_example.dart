...
void main() {
  print("            Chalk'Dart example program           ".cornflowerBlue.onBisque);
  ...
  print('Testing Chalk`Dart!!! DIM DIM red'.red.dim +
      ' then back to blue'.blue);
  ...
  print('Testing Chalk`Dart!!! DIM blue'.blue.dim +
      ' then back to blue'.blue);
  ...
  print(('Testing Chalk`Dart!!! ' + 'THIS IS INVERTED COLOR'.inverse + ' of magenta.onGrey').magenta.onGrey);
  print(('Testing Chalk`Dart!!! ' +
              'THIS IS (${'(THIS IS NESTED INVERTED COLOR)'.inverse})  INVERTED COLOR'.inverse +
              ' of white.onGrey').white.onGrey);

  // make a chalk that will join wrap print with newline
  var chalkNL = chalk.wrap('\n', '');

  print('Testing Chalk`Dart!!!  onGreenBright.redBright.strikethrough'.onBrightGreen.redBright.strikethrough);
  ...
  print('Testing Chalk`Dart!!! blue WITH Red underline'.blue
      .underlineRgb(255, 0, 0)
      .underline);
  print('Testing Chalk`Dart!!! yellow WITH Green underline'.yellow
      .underlineRgb16m(0, 255, 0)
      .underline);

  print('Testing Chalk`Dart!!! yellow WITH blue strikethrough'.yellow
      .underlineRgb16m(0, 0, 255)
      .strikethrough);

  print('Testing Chalk`Dart!!! yellow WITH magenta overline underline AND strikethrough\n'
              .yellow.underlineRgb16m(255, 0, 255).underline.overline.strikethrough);
  ...
  print(([
    'I am a purple line',
    'with a blue bold underline substring'.blue.underline.bold,
    'with a yellow italic g doubleunderline substring'.brightYellow.doubleUnderline
        .italic,
  ...
  print(['Hello', 'World!'.underline, 'Foo', 'bar', 'biz'.blue, 'baz'].join().orangeRed);
  ...
  print(([
    ...
    () => 'Array of Closures #1 Testing Chalk`Dart With Closures - This is return from closure #1!!! DIM blue'.onBlue,
    () => 'Array of Closures #2 and this is the return from closure #2 then back to blue'.brightBlue,
    () => 'This closure called chalk and makes this red'.red,
    () => 
        'And this closure ${"Nest calls to chalk".black.onYellow} inside the closure'.white.onBlue,
  ].join('\n')).goldenrod.onBlack);

  print('Hey There using X11 extensions'.lightGoldenrodYellow.onCornflowerBlue);

  print('Following under/overline color test will only work in vscode. Will be white in terminal.'.red);
  print('Testing Chalk`Dart!!! blue WITH Red double underline'.blue
      .underlineRgb(255, 0, 0)
      .doubleunderline);
  print('Testing Chalk`Dart!!! cornflowerblue WITH Green double underline'.cornflowerBlue.underlineRgb16m(0, 255, 0).doubleunderline);

  print('Testing Chalk`Dart!!! cornflowerblue WITH blue overline and strikethrough'.cornflowerBlue.underlineRgb16m(0, 0, 255).overline.strikethrough);
  print('\n');
  print('Testing Chalk`Dart!!! cornflowerblue WITH white double underline, overline'.cornflowerBlue
  ...
  print('Hello BLUE font 1'.reset.blue +
      ' World' +
      '! font 3 RED'.reset.red);
  ...
  print("  Cascadia Code Ligatures  <> |=> ++ -> <!-- ~~> ->> /= <= ### |>".reset.font6.blueBright);

  print(("FONT 7  " + fontTestString + '\n').reset.font7.white);
  print("  JetBrains Ligatures  <> |=> ++ -> <!-- ~~> ->> /= <= ### |>".reset.font7.white);

  print(("FONT 8  " + fontTestString + '\n').reset.font8.white);

  print(("FONT 9  " + fontTestString + '\n').reset.font9.white);
  print("  JetBrains Ligatures  <> |=> ++ -> <!-- ~~> ->> /= <= ### |>".reset.font9
      .blue);

  print(("FONT 10  -extra wide font - no ligatures " + fontTestString).reset.font10
      .white);
  ...
  print('Hello world! Font blackletter (font 10)'.hsl(90, 1, 0.5)
      .onGreyscale(.5)
      .blackletter);
  print('Hello world! Font 10'.hsl(90, 1, 0.5)
      .onGreyscale(.5)
      .blackletter);
  print('\n');
  ...
  print('Hello world! green text on magenta with green OVERLINE'.hsl(120, 1, 0.5)
      .onMagenta
      .underlineRgb16m(0, 255, 0)
      .overline);

  print('TIMTEST Hello world! .underlineRgb16m KILL STYLE on Android green text on grey with green OVERLINE'.hsl(120, 1, 0.5).onGrey.underlineRgb16m(0, 255, 0).overline);

  print('TIMTEST Hello world! .underlineRgb KILL STYLE on Android green text on grey with green OVERLINE'.hsl(120, 1, 0.5).onGrey.underlineRgb(0, 255, 0).overline);

  print('\n');
  print('Hello world! bright white w/ green OVERLINE'.overline.brightWhite.underlineRgb16m(0, 255, 0));
  print('\n');

  print('this is ${'red superscript txet'.red.superscript} and back to regular text'.brightBlue);
  print('this is ${'yellow subscript text'.yellow.subscript} and back to regular text'.brightBlue);

  print('this is underlined ${'red superscript text'.red.superscript} and back to regular text'.underlined.brightBlue);
  print('this is underlined ${'yellow subscript text'.yellow.subscript} and back to regular text'.underlined.brightBlue);

  print('this is overlined ${'red superscript text'.red.superscript} and back to regular text'.overlined.brightBlue);
  print('this is overlined ${'yellow subscript text'.yellow.subscript} and back to regular text'.overlined.brightBlue);

  print('Yay for ${'red'.red} on dynamically called orange colored text!'.orange);
  print('Yay for ${'chartreuse'.chartreuse} on cornflowerblue colored text!'.chartreuse.onCornflowerBlue);
  print('Yay for underline.color.peachpuff.onPurple colored text!'.underline.peachPuff
      .onPurple);
  print('Yay for x11.MediumSlateBlue.bgMediumVioletRed colored DOUBLE UNDERLINED text!'.doubleUnderline.mediumSlateBlue.onMediumVioletRed);

  var testtim = "Super Way";

  print('Yay for .orangeRed background to ${("purple $testtim inside").purple} back to orangeRed colored text!'.orangeRed);
  print('Yay for lightskyblue colored text!'.lightSkyBlue);

  // Use RGB colors in terminal emulators that support it.
  print('Yay for olive colored text!'.keyword('olive'));
  print('Yay for red on yellow colored text!'.keyword('red')
      .onKeyword('yellow'));
  print('Yay for lightskyblue colored text!'.keyword('lightskyblue'));
  print('Yay for cornflowerblue on darkseagreen colored text!'.keyword('cornflowerblue').bgKeyword('darkseagreen'));
  print('Underlined reddish color rgb(123, 45, 67)'.rgb(123, 45, 67)
      .underline);
